...
export default function HomeImageChagePage({ loadDataUrl }) {
    ...
    const saveToDatabase = async () => {
        ...
        try {
            await axios.post(`${url}${loadDataUrl}/Catalogue`, formData, { headers: { 'Content-Type': 'multipart/form-data', }, });
            setSeverity('success');
            setSnackbar(true);
        } catch (error) {
            setSeverity('error');
    ...
    const updateDatabase = async () => {
        ...
        try {
            await axios.put(`${url}${loadDataUrl}/Catalogue/${form.id}`, formData, { headers: { 'Content-Type': 'multipart/form-data', }, });
            setSeverity('success');
            setSnackbar(true);
        } catch (error) {
            setSeverity('error');
