...
import { Grid, Switch, Typography, IconButton, SvgIcon, Popover, Dialog, Button, DialogContent, DialogActions, Box } from '@mui/material';
...
export const ImageModal2 = ({ isOpen, imageSrc, onClose }) => {
    const [imageStyle, setImageStyle] = useState({ width: '100%', maxWidth: '85svh' });
        ...
        if (imageSrc) {
            ...
            img.onload = () => {
                if (img.width < img.height) {
                    setImageStyle({ width: 'auto', height: '83svh' });
                } else {
                    setImageStyle({ width: '85svw', maxWidth: '83svh' });
                }
            };
        }
    }, [imageSrc]);
    ...
    return (
        <Dialog open={isOpen} onClose={onClose} maxWidth={'xl'}>
            <DialogContent>
                <img src={imageSrc} alt="Enlarged Image" style={imageStyle} />
            </DialogContent>
            <DialogActions>
                <Button onClick={onClose}>Close</Button>
            </DialogActions>
...
export const IMG = process.env.REACT_APP_API_URL_IMG;
export const TEST = process.env.REACT_APP_API_URL_TEST;
export const KAKAO = process.env.REACT_APP_API_URL_KAKAO;